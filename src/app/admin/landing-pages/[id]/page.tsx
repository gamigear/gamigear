  ...
  return (
    <div className="space-y-6">
          ...
          <Card title="Hero Section">
            <div className="p-4 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="VD: Black Friday Sale"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                {form.heroImage && (
                  <img src={form.heroImage} alt="Hero" className="mt-2 h-32 rounded-lg object-cover" />
                )}
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="/shop hoặc #products"
                  />
                </div>
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, heroBackground: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="linear-gradient(135deg, #667eea 0%, #764ba2 100%)"
                />
                <div
                  className="mt-2 h-12 rounded-lg"
                  style={{ background: form.heroBackground || "#667eea" }}
                />
              </div>
            </div>
          </Card>
            ...
            <Card title="Countdown">
              <div className="p-4 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="countdownEnabled" className="text-sm font-medium text-gray-700">
                    Bật đếm ngược
                  </label>
                </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setForm({ ...form, countdownEndDate: e.target.value })}
                        className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
                  </>
            ...
            <div className="p-4 space-y-4">
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => setForm({ ...form, showProducts: e.target.checked })}
                  className="w-4 h-4 text-blue-600 rounded"
                />
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="VD: Sản phẩm khuyến mãi"
                    />
                  </div>
          ...
          <Card title="Call to Action">
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={form.ctaBackground || ""}
                  onChange={(e) => setForm({ ...form, ctaBackground: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <div
                  className="mt-2 h-12 rounded-lg"
                  style={{ background: form.ctaBackground || "#f5576c" }}
                />
              </div>
            </div>
          </Card>
          ...
          <Card title="Trạng thái">
            <div className="p-4">
              ...
              <p className="text-xs text-gray-500 mt-2">
                {form.isActive ? "Landing page đang hiển thị" : "Landing page đang ẩn"}
              </p>
            </div>
          </Card>
          ...
          <Card title="Custom CSS">
            <div className="p-4">
              <textarea
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500"
                rows={6}
                placeholder=".hero { ... }"
              />
            </div>
      ...
      <MediaPicker
        ...
        currentImage={form[mediaTarget as keyof typeof form] as string}
